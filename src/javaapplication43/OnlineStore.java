...
public class OnlineStore extends javax.swing.JFrame {
    ...
    public OnlineStore(String user) {
        initComponents();
        username = user;
    }
    ...
    private void initComponents() {
        ...
        jPanel4.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 87, 786, -1));
        ...
        jPanel4.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        order.setFont(new java.awt.Font("Berlin Sans FB", 0, 14)); // NOI18N
        order.setText("ORDER ");
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, -1, -1));
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 30, -1, -1));
        ...
        jPanel2.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 30, -1, -1));
...
Shirts Info = new Shirts(username);
        this.dispose();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
     ACCESSORIES Info = new ACCESSORIES(username);
        this.dispose();
        Info.setDefaultCloseOperation(EXIT_ON_CLOSE);
        Info.setVisible(true);  // TODO add your handling code here:
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
     ELECTRONICS Info = new ELECTRONICS(username);
        this.dispose();
        Info.setDefaultCloseOperation(EXIT_ON_CLOSE);
        Info.setVisible(true);    //ELECTRONICS Info=new ELECTRONICS();   
   // Info.setVisible(true); // TODO add your handling code here:
